...
// الرموز
const SYMBOLS = [
  { img: "اجر.حصان.لعبة.ثالثة.jpg", payouts: { 3: 1, 4: 2, 5: 4 } },
  { img: "الماس.لعبة.ثالثة.jpg", payouts: { 3: 2, 4: 4, 5: 8 } },
  { img: "سبعة.اطار.لعبة.ثالثة.jpg", payouts: { 3: 3, 4: 6, 5: 12 } },
  { img: "بستون.لعبة.ثالثة.jpg", payouts: { 3: 4, 4: 8, 5: 16 } },
  { img: "حرف.A.لعبة.ثالثة.jpg", payouts: { 3: 5, 4: 10, 5: 20 } },
  { img: "سبعة.لعبة.ثالثة.jpg", payouts: { 3: 6, 4: 12, 5: 25 } },
  { img: "ويلد.لعبة.ثالثة.jpg", payouts: { 3: 2, 4: 5, 5: 10 } },
  { img: "حرف.لعبة.ثالثة.jpg", payouts: { 3: 3, 4: 7, 5: 14 } },
  { img: "حرفQ.لعبة.ثالثة.jpg", payouts: { 3: 4, 4: 9, 5: 18 } },
  { img: "حرفk.لعبة.ثالثة.jpg", payouts: { 3: 5, 4: 11, 5: 22 } },
  { img: "كنز.لعبة.ثالثة.jpg", payouts: { 3: 7, 4: 15, 5: 30 } }
];
